...
function addTodo()
{
    ...
    <div style="margin-left: 400px; margin-bottom: 10px;" id="${ctr}">
        ...
        <button style="margin-left: 10px; height:30px; background-color:white; border:none; border-radius: 4px;"
         ...
         <button style="margin-left: 10px; height:32px; background-color:white; border:none; border-radius: 4px;"
